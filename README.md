...
| Plugin `data.json` | Storage V2 settings, layout scenes, toolbar, RSS config, morning-brief routing, Apple Calendar target/event-UID mappings, AI model config (**API keys are stored here in plain text**) |
