...
assert.match(framework, /new Set\(\['focusChart', 'scheduledTasks', 'habits', 'weeklyReview', 'projects', 'resurface', 'agenda', 'workflows', 'reportStudio', 'teamStats', 'runHistory', 'syncHealth'\]\)/, 'Advanced modules stay hidden until the user opts in on a fresh dashboard.');
