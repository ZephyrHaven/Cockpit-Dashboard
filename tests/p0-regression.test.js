...
assert.match(framework, /new Set\(\['focusChart', 'scheduledTasks', 'habits', 'weeklyReview', 'projects', 'resurface', 'agenda'\]\)/, 'Advanced modules stay hidden until the user opts in on a fresh dashboard.');
